		...
		<div class="top-info">
			<div class="top-left">
				<c:if test="${user!=null }">
					<div id="arrow1" class="user-name" style="margin-bottom: 10px">
						<a href="myinfo.jsp">欢迎您！ ${user.username }</a> &nbsp; <span
				...
				<c:if test="${user==null }">
					<div id="arrow1" class="user-name">
						<a href="/eat/user/login.do">登录</a> <span class="down-icon"></span>
					</div>
					<div id="arrow2" class="user-name">

						<a href="register.jsp">注册</a> <span class="down-icon"></span>
					</div>
				</c:if>
			...
			<div class="top-right">
				...
				<div data-toggle="arrowdown" id="arrow5" class="user-name">
					...
					<a href="${pageContext.request.contextPath }/admin/cart.jsp"><img
						src="/eat/img/cart.png">购物车</a> <span class="down-icon"></span>
				</div>
				...
				<div data-toggle="arrowdown" id="arrow7" class="user-name">
					<img src="/eat/img/418.png" style="margin-top: -10px"> <a
						href="pageallEat.do">网站导航</a> <span class="down-icon"></span>
				</div>
