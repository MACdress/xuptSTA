...
<script type="text/javascript">
	function adduser() {
		window.location.href = "${pageContext.request.contextPath}/admin/orderlist/add.jsp";
	}
	
	
	function deluser(id){
		if(confirm("是否确定删除?")){
			location.href="${pageContext.request.contextPath }/order/delUser.do?id="+id;
		}
	}
...
<center><h1 style="margin-bottom: 30px">订单后台管理系统</h1></center>
		...
		<form action="${pageContext.request.contextPath }/servlet/delAllusersServlet" method="post">
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="10%">购买账号</td>
				...
				<c:forEach items="${users }" var="b">							
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="  HEIGHT: 22px" align="center"
										width="5%"><input type="checkbox" name="ids" value="${b.orderId }"/></td>
									<td style="  HEIGHT: 22px" align="center"
										width="18%">${b.orderId }</td>
									<td style="  HEIGHT: 22px" align="center"
										width="10%">${b.relname }</td>
									<td style="  HEIGHT: 22px" align="center"
										width="8%">${b.address }</td>
									<td style="  HEIGHT: 22px" align="center"
										width="8%">${b.total }</td>
									
										<td style=" HEIGHT: 22px" align="center">${b.orderTime }</td>
									<td style=" HEIGHT: 22px" align="center">${b.tell }</td>
									
									<c:if test="${user.category=='highadmin' }">
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="javascript:deluser('${b.orderId }')" style="color: red;font-family:700px;text-decoration: none">
											X
									</a>
									</td>
									</c:if>
