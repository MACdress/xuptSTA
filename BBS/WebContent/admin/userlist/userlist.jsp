...
<script type="text/javascript">
	function adduser() {
		window.location.href = "${pageContext.request.contextPath}/admin/userlist/add.jsp";
	}
...
<center><h1 style="margin-bottom: 30px">用户后台管理系统</h1></center>
		...
		<form action="${pageContext.request.contextPath }/servlet/delAllusersServlet" method="post">
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="18%">人员编号</td>
								<td align="center" width="10%">人员账号</td>
						<!-- 		<td align="center" width="9%">人员密码</td> -->
								<td align="center" width="9%">姓名</td>
								<td width="8%" align="center">性别</td>
								<td width="8%" align="center">权限类别</td>
				...
				<c:forEach items="${users }" var="b">							
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="  HEIGHT: 22px" align="center"
										width="18%">${b.id }</td>
									<td style="  HEIGHT: 22px" align="center"
										width="10%">${b.username }</td>
									<%-- <td style="  HEIGHT: 22px" align="center"
										width="8%">${b.password }</td> --%>
									<td style="  HEIGHT: 22px" align="center"
										width="8%">${b.relname }</td>
									<td style="  HEIGHT: 22px" align="center"
										width="8%">${b.sex }</td>
									<td style=" HEIGHT: 22px" align="center">${b.category }</td>
									<td style="  HEIGHT: 22px" align="center"
										width="10%"><a href="${pageContext.request.contextPath}/user/detail.do?id=${b.id }" style="color: green;text-decoration: none">more...</a></td>
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath}/user/findUserById.do?id=${b.id }" style="color: blue;text-decoration: none">
											edit</a>
									</td>
									<c:if test="${user.category=='highadmin' }">
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="javascript:deluser('${b.id }','${b.username }')" style="color: red;font-family:700px;text-decoration: none">
											X
									</a>
									</td>
									</c:if>
